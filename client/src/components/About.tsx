          ...
          <div className="md:w-1/2">
            ...
            >
              <p className="mb-6 font-mono text-gray-200 leading-relaxed tracking-wide text-[15px]">
                ...
                Bachelor’s degree in Cybersecurity at Guardia Cybersecurity
                School, passionate about safeguarding digital systems and
                sensitive data. Through my academic projects and early
                professional experience, I have developed strong skills in{" "}
                <span className="text-[#00FF8C]">penetration testing</span>,
          ...
          <div className="md:w-1/2">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-400 mb-1">Guardia</p>
